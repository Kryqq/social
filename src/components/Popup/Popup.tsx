...
const Popup = () => {
   const { activePopup, setActivePopup } = useContext(Context);

   return (
      <div>
         {activePopup ? (
            <div className={styles.popup__container_first} >
                     ...
                     <div className={styles.popup__login}>
                        <div className={styles.popup__login_info}>
                           <div className={styles.popup__login_info_input}>
                              <input className={styles.popup__login_info_input_pos}></input>
                              <svg
                                 width="22px"
                                 height="20px"
