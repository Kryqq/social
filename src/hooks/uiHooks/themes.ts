...
export const tokens = (theme: string) => ({
   ...(theme === 'dark'
      ? {
           primary: {
              DEFAULT: '#000000',
...
export const themeSettings: any = (mode: string) => {
   ...
   return {
      palette: {
         ...
         ...(mode === 'dark'
            ? {
                 primary: { main: colors.black.DEFAULT },
                 secondary: { main: colors.gray.DEFAULT },
                 neutral: { dark: colors.black[500], light: colors.white[100] },
              }
            : {
                 primary: { main: colors.white.DEFAULT },
                 secondary: { main: colors.gray.DEFAULT },
                 neutral: { dark: colors.black[500], light: colors.white[100] },
              }),
      },
